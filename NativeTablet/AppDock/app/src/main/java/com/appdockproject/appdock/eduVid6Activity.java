    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devBtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                Intent intent = new Intent(eduVid6Activity.this, devActivity.class);
        ...
        eduBtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                Intent intent = new Intent(eduVid6Activity.this, eduActivity.class);
                startActivity(intent);
            }
        });
        ...
        homeBtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                Intent intent = new Intent(eduVid6Activity.this, appPage.class);
                startActivity(intent);
            }
        });
        ...
        cmntBtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                Intent intent = new Intent(eduVid6Activity.this, feedbackActivity.class);
                startActivity(intent);
            }
        });
        ...
        fbBtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                Intent intent = new Intent(eduVid6Activity.this, facebookActivity.class);
                startActivity(intent);
            }
        });
